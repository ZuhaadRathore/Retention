# Flash-AI Python Sidecar

Local FastAPI service that handles semantic scoring, deck metadata persistence, and background model preparation for the Flash-AI desktop shell.

## Quickstart
- Create and activate a virtual environment targeting Python 3.10+.
- Install dependencies with "pip install -e .[dev]".
- Initialize the SQLite database using "flash-ai-init-db".
